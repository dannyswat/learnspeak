        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <img src="/learnspeak2.png" alt="LearnSpeak" className="h-12" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-green-500 to-emerald-600 px-8 py-10 text-white">
            ...
            <p className="text-green-100 text-lg">by {invitation.creatorName}</p>
          </div>
          ...
          <div className="px-8 py-8">
            ...
            {/* About LearnSpeak */}
            <div className="mb-8 p-6 bg-gradient-to-r from-gray-50 to-green-50 rounded-lg border border-gray-200">
            ...
            <div className="border-t border-gray-200 pt-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  ...
                  className="px-8 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white font-semibold rounded-lg hover:from-green-700 hover:to-emerald-700 shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
                >
                  Create Account
                </button>
                <button
                  onClick={handleLogin}
                  className="px-8 py-3 bg-white text-green-600 font-semibold rounded-lg border-2 border-green-600 hover:bg-green-50 transition-all"
                >
                  Sign In
                </button>
              </div>
